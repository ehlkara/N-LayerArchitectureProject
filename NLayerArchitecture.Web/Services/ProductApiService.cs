...
namespace NLayerArchitecture.Web.Services
{
    public class ProductApiService
    {
        ...
        public async Task<bool> UpdateAsync(ProductDto updatedProduct)
        {
            var response = await _httpClient.PutAsJsonAsync("products", updatedProduct);
